pub mod ext {
    ...
    pub fn parse_err_to_message(error: &HurlParseErrorEnum) -> String {
        match error {
            ...
            HurlParseErrorEnum::Json {err} => err.to_string(),
            ...
            HurlParseErrorEnum::InvalidOption(err) => err.to_string(),
    ...
    impl From<ParseError> for HurlParseErrorEnum {
        fn from(value: ParseError) -> Self {
            match value {
                ...
                ParseError::InvalidOption(err) => HurlParseErrorEnum::InvalidOption(err),
                ParseError::Json(err) => HurlParseErrorEnum::Json {err: format!("{err:?}") },
