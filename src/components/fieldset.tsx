...
export function Legend({ ...props }: HeadlessLegendProps) {
  return (
    <HeadlessLegend
      ...
      className={clsx(
        props.className,
        "text-base/6 font-semibold text-second data-[disabled]:opacity-50 sm:text-sm/6 dark:text-white",
      )}
    />
  );
}
...
export function Label({
  ...
  return (
    <HeadlessLabel
      ...
      className={clsx(
        className,
        "select-none text-base/6 text-second data-[disabled]:opacity-50 sm:text-sm/6 dark:text-white",
      )}
    />
  );
}
