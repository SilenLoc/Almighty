      ...
      >
        <HeadlessSelect
          ...
          className={clsx([
            ...
            // Typography
            "text-base/6 text-second placeholder:text-neutral sm:text-sm/6 dark:text-white dark:*:text-white",

            // Border
            "border border-neutral/10 data-[hover]:border-neutral/20 dark:border-white/10 dark:data-[hover]:border-white/20",

            // Background color
            "bg-transparent dark:bg-white/5 dark:*:bg-neutral",
            ...
            // Disabled state
            "data-[disabled]:border-neutral/20 data-[disabled]:opacity-100 dark:data-[hover]:data-[disabled]:border-white/15 data-[disabled]:dark:border-white/15 data-[disabled]:dark:bg-white/[2.5%]",
          ])}
        />
        {!multiple && (
          <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
            <svg
              className="size-5 stroke-neutral group-has-[[data-disabled]]:stroke-neutral sm:size-4 dark:stroke-neutral forced-colors:stroke-[CanvasText]"
              viewBox="0 0 16 16"
              aria-hidden="true"
              fill="none"
            >
