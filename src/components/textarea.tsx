    ...
    >
      <HeadlessTextarea
        ...
        className={clsx([
          ...
          // Typography
          "text-base/6 text-second placeholder:text-third sm:text-sm/6 dark:text-white",
          ...
          // Disabled state
          "disabled:border-third/20 disabled:dark:border-white/15 disabled:dark:bg-white/[2.5%] dark:data-[hover]:disabled:border-white/15",
