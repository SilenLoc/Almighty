    ...
    >
      <HeadlessTextarea
        ...
        className={clsx([
          ...
          // Typography
          "text-base/6 text-second placeholder:text-neutral sm:text-sm/6 dark:text-white",
          ...
          // Disabled state
          "disabled:border-neutral/20 disabled:dark:border-white/15 disabled:dark:bg-white/[2.5%] dark:data-[hover]:disabled:border-white/15",
